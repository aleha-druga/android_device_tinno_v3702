...
LINKER_FORCED_SHIM_LIBS := $(LINKER_FORCED_SHIM_LIBS):/system/lib/libmedia.so|libmtkshim_oth.so:/system/lib/libstagefright.so|libmtkshim_oth.so:/system/lib/libcam_utils.so|libmtkshim_oth.so
endif
